...
export const criarChamadoController = async (req, res) => {
  ...
  try {
    ...
    const dadosChamado = {assunto, tipo_id: tipo_id || null, descricao, prioridade: prioridade || 'none', imagem: imagem || null,
                          usuario_id: usuario_id || null, patrimonio: patrimonio || null, data_limite};
