...
INSERT INTO avaliacoes (usuario_id, chamado_id, tecnico_id, nota, comentario, data_avaliacao) VALUES
(11, 1, 4, 5, 'Atendimento excelente, problema resolvido rapidamente.', '2025-02-10 09:12:00'),
(12, 2, 5, 4, 'Bom atendimento, porém demorou um pouco para retornar.', '2025-02-15 14:30:00'),
(13, 3, 6, 3, 'Resolveu parcialmente, precisei abrir novo chamado.', '2025-03-01 11:05:00'),
(14, 4, 7, 5, 'Técnico muito educado e eficiente.', '2025-03-07 16:20:00'),
(15, 5, 4, 2, 'Não resolveu, voltou depois e ficou melhor.', '2025-03-10 10:45:00'),
(16, 6, 8, 4, 'Ótimo suporte, explicou bem o que estava acontecendo.', '2025-03-20 09:00:00'),
(17, 7, 5, 5, 'Atendimento rápido e solução definitiva.', '2025-04-02 13:50:00'),
(18, 8, 9, 3, 'Atendeu, mas faltou equipamento para finalizar.', '2025-04-10 08:30:00'),
(19, 9, 10, 4, 'Bom serviço, apenas um pequeno atraso.', '2025-04-15 15:15:00'),
(20, 10, 4, 5, 'Profissional competente e pontual.', '2025-04-25 12:10:00'),
(21, 11, 11, 2, 'Problema voltou no dia seguinte.', '2025-05-02 09:40:00'),
(22, 12, 12, 4, 'Solução adequada, explicou os procedimentos.', '2025-05-12 11:22:00'),
(23, 13, 5, 5, 'Muito satisfeito com o atendimento.', '2025-05-20 14:05:00'),
(11, 14, 5, 3, 'Atendimento padrão; poderia ter sido mais claro.', '2025-05-28 10:00:00'),
(12, 15, 4, 4, 'Bom, mas demorou a chegada do técnico.', '2025-06-04 09:15:00'),
(13, 16, 6, 5, 'Excelente suporte, resolveu na primeira visita.', '2025-06-11 16:00:00'),
(14, 17, 6, 1, 'Péssima experiência; não resolveu nada.', '2025-06-20 08:30:00'),
(15, 18, 5, 4, 'Satisfatório, técnico atencioso.', '2025-06-25 13:45:00'),
(16, 19, 10, 5, 'Rápido e eficiente. Recomendo.', '2025-07-02 10:20:00'),
(17, 20, 11, 3, 'Resolveu, mas deixou algumas dúvidas.', '2025-07-10 11:11:00'),
(18, 1, 7, 4, 'Bom atendimento em manutenção preventiva.', '2025-07-18 09:55:00'),
(19, 2, 8, 5, 'Ótimo trabalho, muito profissional.', '2025-07-25 14:30:00'),
(20, 3, 5, 2, 'Demorou e voltou sem solução completa.', '2025-08-01 08:00:00'),
(21, 4, 9, 4, 'Atendimento competente, dentro do esperado.', '2025-08-08 12:45:00'),
(22, 5, 12, 5, 'Muito bom — resolveu e explicou tudo.', '2025-08-15 15:20:00');
