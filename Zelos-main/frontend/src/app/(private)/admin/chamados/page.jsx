...
export default function ChamadosAdmin() {
  ...
  return (
    <>
          ...
          <div className='flex flex-row w-full justify-between mb-15'>
            <div className="w-fit flex flex-row ">
              ...
              <div className="relative inline-block">
                <button onClick={() => setDropdownSetorAberto(!dropdownSetorAberto)} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 poppins-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" id="dropdownHelperButton">
                  Setor
                          ...
                          <li key={setor.id}>
                            <div className="flex p-2 rounded-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                              ...
                              <div className="ms-2 text-sm">
                                <label htmlFor={`helper-checkbox-${index}`} className="poppins-medium text-gray-900 dark:text-gray-300">
                                  <div>{setor.titulo.replace(/_/g, " ")}</div>
                                  <p className="text-xs poppins-regular text-gray-500 dark:text-gray-300">
              ...
              <div className="relative inline-block">
                <button
                  ...
                  className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 poppins-medium rounded-lg text-sm px-8 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  type="button"
          ...
          <section>
                        ...
                        <div key={chamado.id} onClick={() => { setChamadoSelecionado(chamado); setIsOpen(true); }} className=" p-4 md:p-5 flex flex-col bg-white border border-gray-200 border-t-4 border-t-blue-600 shadow-2xs rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:border-t-blue-500 dark:shadow-neutral-700/70 cursor-pointer">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <p className="text-sm poppins-bold text-gray-800 dark:text-white">{chamado?.nome_usuario || 'Nome não encontrado'}</p>
                            </div>
                            <div>
            ...
            <div id="drawer-right-example" className={`fixed top-0 right-0 z-99 h-screen p-4 overflow-y-auto transition-transform border-l border-gray-200 dark:border-neutral-700 bg-white w-80 dark:bg-gray-800 ${isOpen ? "translate-x-0" : "translate-x-full"}`} tabIndex="-1" aria-labelledby="drawer-right-label" >
              ...
              <div>
                ...
                <p className="mb-6 text-sm poppins-bold text-gray-800 dark:text-gray-400">Usuário</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="mb-6 text-sm poppins-bold text-gray-800 dark:text-gray-400">{chamadoSelecionado?.imagem}</p>
              </div>
              <div>
                ...
                <div className="mb-6 text-sm poppins-bold text-gray-800 dark:text-gray-400">
                  {!chamadoSelecionado?.tecnico_id ? (
                    <>
                      ...
                      <button id="dropdownUsersButton" data-dropdown-toggle="dropdownUsers" data-dropdown-placement="bottom" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 poppins-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" > Adicionar funcionário<svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6" ><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
                      </svg>
                      </button>
      ...
      "limit": 3
    }' className="py-1.5 px-2 inline-flex items-center gap-x-1 text-xs poppins-medium rounded-full border border-dashed border-gray-200 bg-white text-gray-800 hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700">
                      ...
                      <div id="dropdownUsers" className="z-10 hidden bg-white rounded-lg shadow-sm w-60 dark:bg-gray-700" >
                        ...
                        <a
                          href="#"
                          className="flex items-center p-3 text-sm poppins-medium text-blue-600 border-t border-gray-200 rounded-b-lg bg-gray-50 dark:border-gray-600 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-blue-500 hover:underline"
                        >
                          <svg
