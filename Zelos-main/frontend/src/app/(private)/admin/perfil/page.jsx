                    ...
                    <div className="relative p-4 w-full max-w-md max-h-full">
                        <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                            ...
                            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                                <h3 className="text-xl poppins-semibold text-gray-900 dark:text-white">
                                    Editar informações
                                </h3>
                            ...
                            <div className="p-4 md:p-5">
                                <form className="space-y-4" action="#" onSubmit={handleSubmit}>
                                    <div>
                                        <label htmlFor="email" className="block mb-2 text-sm poppins-medium text-gray-900 dark:text-white">Username</label>
                                    ...
                                    <div>
                                        <label htmlFor="email" className="block mb-2 text-sm poppins-medium text-gray-900 dark:text-white">Email</label>
                                    ...
                                    <div>
                                        <label htmlFor="senha" className="block mb-2 text-sm poppins-medium text-gray-900 dark:text-white">Senha</label>
                                    ...
                                    {resposta && (
                                        <div className="text-center text-red-500 poppins-medium">
                                            {resposta}
                                        </div>
                                    )}
                                    <button type="submit" className="w-full text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 poppins-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">Salvar Alterações</button>
