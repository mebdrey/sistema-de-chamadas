                ...
                <div className="mt-4 space-y-3">
                  ...
                  <form className="w-full" onSubmit={handleCreateUser}>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      {/* Email */}
                      <div className="relative z-0 mb-5 group w-full md:w-60">
                        <input type="email" name="email" id="user_email" className={`block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 appearance-none ${submitAttempted && errors.email ? 'border-red-500' : 'border-gray-300'} dark:text-gray-100 dark:border-gray-600 dark:focus:border-purple-500 focus:outline-none focus:ring-0 ${submitAttempted && errors.email ? 'focus:border-red-500' : 'focus:border-[#7F56D8]'} peer`} placeholder=" " value={form.email} onChange={(e) => {
                          handleEmailChange(e);
