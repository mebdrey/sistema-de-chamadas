                            ...
                            <tr className="bg-white dark:bg-gray-900">
                              ...
                              <td className="px-6 py-2">
                                <textarea placeholder="Descrição do setor"
                                  ...
                                  onChange={(e) => setNovoSetor(prev => ({ ...prev, descricao: e.target.value }))}
                                  className="w-full p-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm text-gray-700 dark:text-gray-200 placeholder-gray-400 whitespace-normal break-words focus:outline-none focus:ring-2 focus:ring-[#7F56D8] focus:border-[#7F56D8] transition" rows={2} />
                              </td>
