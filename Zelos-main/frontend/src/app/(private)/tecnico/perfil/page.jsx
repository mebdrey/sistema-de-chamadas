        ...
        <section>
            ...
            <div className='user flex items-center gap-3 border-b border-[#D0D0D0]'>
                <div className="font-medium">
                    <h3>teste{/*{nomeSobrenome.primeiroNome} */}</h3>
                    <p className="text-sm text-gray-500">testeSobrenome{/*{nomeSobrenome.ultimoNome}*/} </p>
                </div>
            </div>
            {/*NOME DE USUÁRIO */}
            <div className='sec'>
                ...
                <div className='sec-container flex flex-wrap flex-row justify-between gap-3'>
                    <div className='sec-campos'><h6>Nome completo:</h6><p>teste teste{/*{usuario.nome}*/}</p></div>
                </div>
            </div>
            <div className='sec'>
                <div className='sec-indicador'><h4>Sobre</h4><hr/></div>
                <div className='sec-container flex flex-wrap flex-row justify-between gap-3'>
                    <div className='sec-campos'><h6>Departamento:</h6><p>administração{/*{usuario.nome}*/}</p></div>
                </div>
                <div className='sec-container flex flex-wrap flex-row justify-between gap-3'>
                    <div className='sec-campos'><h6>Status:</h6><p>Ativo{/*{usuario.nome}*/}</p></div>
                </div>
            </div>
            ...
            <div className='sec'>
                ...
                <div className='sec-container flex flex-wrap flex-row justify-between gap-3'>
                    <div className='sec-campos'><h6>Email pessoal:</h6><p>teste@gmail.com{/*{usuario.email}*/}</p></div>
