    ...
    <>
      ...
      <div className="grid grid-cols-1 border-t border-gray-200 pt-5">
        <div className="flex justify-between items-center">
          ...
          <div className="relative">
            <button className="uppercase text-sm poppins-semibold inline-flex gap-2 items-center rounded-lg text-[#7F56D8] hover:bg-[#E6DAFF] px-3 py-2 hover:cursor-pointer" onClick={() => setDropdownRelatorioOpen(prev => !prev)}>Gerar relatório
