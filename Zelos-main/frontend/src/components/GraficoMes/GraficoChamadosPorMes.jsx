...
// grafico - chamados no mes de (?)
  ...
  return(
    ...
    {/* grafico grande com o total de chamados */}
                  ...
                  <div className="mt-4">
                    <ApexChart options={options} series={options.series} type="area" height={200} />
                  </div>
                  <div className="grid grid-cols-1 border-t border-gray-200 dark:border-gray-700 pt-5">
                    <div className="flex justify-between items-center">
                      <div className="relative">
                        <button onClick={() => setDropdownOpen(!dropdownOpen)} className="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white inline-flex items-center">
                          ...
                          <div className="absolute z-10 mt-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg shadow-sm w-44">
                            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                              {['Alta', 'Baixa', 'Média'].map((label) => (
                                <li key={label}>
                                  <button className="w-full text-left px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => {setDropdownOpen(false) }}>
                                    {label}
                                  </button>
                                </li>
                              ))}
