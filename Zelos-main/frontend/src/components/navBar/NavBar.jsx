                            ...
                            {links.map((link) => (
                                <li key={link.href}>
                                    <a href={link.href} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-[#E6DAFF] group">
                                        {link.icon}
                                        <span className="ml-3 transition-all duration-200 text-gray-500 group-hover:text-[#7F56D8]">{link.label}</span>
                                    </a>
                    ...
                    <ul className="space-y-2 poppins-medium">
                        {links.map((link) => (
                            <li key={link.href}>
                                <a href={link.href} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-[#E6DAFF] group">
                                    {link.icon}
                                    <span className={"ml-3 transition-all duration-200 text-gray-500 group-hover:text-[#7F56D8]" + (navFechada ? "opacity-0 w-0 overflow-hidden" : "opacity-100 w-auto")}>
                                        {link.label}
                                    </span>
                                </a>
                            </li>
